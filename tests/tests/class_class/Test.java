...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        Class[] classes = new Class[]{Test.class, Comparable.class, System.class, ArrayList.class, Class.forName("[B"), Class.forName("[[S"), Class.forName("[LTest;"), double.class, Integer.class};
