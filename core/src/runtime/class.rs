...
/// The representation of a Java class.
///
/// This stores the class file, loader, name, super class, interfaces, and all
/// other details of a class. Class instances ([`Object`]s) can be created
/// using [`Class::new_instance`].
#[derive(Clone, Copy)]
